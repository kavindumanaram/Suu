...
create table [User] (
    ...
    [profile_background_image_url] [varchar](50) NULL,
    [profile_background_image_url_https] [varchar](50) NULL,
    [profile_background_tile] bit  NULL,
    [profile_image_url] [varchar](50) NULL,
    [profile_image_url_https] [varchar](50) NULL,
    [profile_banner_url] [varchar](50) NULL,
